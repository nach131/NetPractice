...
var ifs = [
    { 'if': 'A1', 'hid': 'A', 'ip': '192.168.[14-150]a.200', 'mask': '255.255.255.224', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '-90,-50' },
    { 'if': 'B1', 'hid': 'B', 'ip': '192.168.[a].222', 'mask': '255.255.255.224', 'ip_edit': 'false', 'mask_edit': 'true', 'type': 'std', 'pos': '110,200' },
    { 'if': 'C1', 'hid': 'C', 'ip': '192.168.10.1', 'mask': '255.255.255.252', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '-90,-50' },
    { 'if': 'D1', 'hid': 'D', 'ip': '192.168.10.2', 'mask': '/30', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '110,200' }
