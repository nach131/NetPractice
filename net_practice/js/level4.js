...
var ifs = [
    { 'if': 'A1', 'hid': 'A', 'ip': '[60-125]a.[1-254]b.[110-119]c.132', 'mask': '255.255.255.128', 'ip_edit': 'false', 'mask_edit': 'true', 'type': 'std', 'pos': '0,-50' },
    { 'if': 'B1', 'hid': 'B', 'ip': '93.195.119.130', 'mask': '255.255.255.128', 'ip_edit': 'true', 'mask_edit': 'true', 'type': 'std', 'pos': '100,200' },
    { 'if': 'R1', 'hid': 'R', 'ip': '93.195.119.129', 'mask': '255.255.255.128', 'ip_edit': 'true', 'mask_edit': 'true', 'type': 'std', 'pos': '190,10' },
