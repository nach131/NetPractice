...
var ifs = [
    { 'if': 'A1', 'hid': 'A', 'ip': '104.198.[1-254]a.125', 'mask': '255.255.255.128', 'ip_edit': 'false', 'mask_edit': 'true', 'type': 'std', 'pos': '0,-50' },
    { 'if': 'B1', 'hid': 'B', 'ip': '104.198.79.2', 'mask': '255.255.255.128', 'ip_edit': 'true', 'mask_edit': 'true', 'type': 'std', 'pos': '100,200' },
    { 'if': 'C1', 'hid': 'C', 'ip': '104.198.79.1', 'mask': '255.255.255.128', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '190,10' },
