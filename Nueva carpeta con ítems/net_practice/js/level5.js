...
var routes = [
    { 'hid': 'A', 'rid': 'Ar1', 'route': 'default', 'gate': '25.218.175.126', 'route_edit': 'true', 'gate_edit': 'true' },
    { 'hid': 'B', 'rid': 'Br1', 'route': 'default', 'gate': '166.50.226.254', 'route_edit': 'false', 'gate_edit': 'true' }
];


var ifs = [
    { 'if': 'A1', 'hid': 'A', 'ip': '25.218.175.1', 'mask': '255.255.255.128', 'ip_edit': 'true', 'mask_edit': 'true', 'type': 'std', 'pos': '0,-50' },
    { 'if': 'B1', 'hid': 'B', 'ip': '166.50.226.1', 'mask': '255.255.192.0', 'ip_edit': 'true', 'mask_edit': 'true', 'type': 'std', 'pos': '100,200' },
