...
var routes = [
    { 'hid': 'A', 'rid': 'Ar1', 'route': '0.0.0.0/0', 'gate': '24.52.39.129', 'route_edit': 'true', 'gate_edit': 'true' },
    { 'hid': 'R', 'rid': 'Rr1', 'route': 'default', 'gate': '163.172.250.1', 'route_edit': 'true', 'gate_edit': 'false' },
    { 'hid': 'I', 'rid': 'Ir1', 'route': '24.52.39.129/25', 'gate': '163.172.250.12', 'route_edit': 'true', 'gate_edit': 'false' }
...
var ifs = [
    { 'if': 'A1', 'hid': 'A', 'ip': '24.52.39.227', 'mask': '255.255.255.128', 'ip_edit': 'false', 'mask_edit': 'true', 'type': 'std', 'pos': '0,-50' },
    { 'if': 'R1', 'hid': 'R', 'ip': '24.52.39.129', 'mask': '255.255.255.128', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '190,10' },
