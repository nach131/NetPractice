...
var ifs = [
    ...
    { 'if': 'A1', 'hid': 'A', 'ip': '104.94.23.[260-300]a', 'mask': '255.255.255.0', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '-90,-50' },
    ...
    { 'if': 'D1', 'hid': 'D', 'ip': '211.191.[260-300]d.42', 'mask': '255.255.0.0', 'ip_edit': 'true', 'mask_edit': 'false', 'type': 'std', 'pos': '110,200' }
];
